...
<div class="page-content-wrapper">
			...
			<div class="row row-fd">
				<div class="col-lg-3">
					<div class="categories">
						<h2 class="categories__title">Популярные проекты</h2>
					...
					<div class="hidden">
						<div id="orderCalcForm" class="popup-form order-calc-form">
							<div class="popup-form__title">
								<h3 class="form-title">Рассчитать стоимость строительства</h3>
								...
								<div class="project-portfolio-blocks__img">
									<?php if ( get_sub_field( 'project_portfolio_block_img' ) ) { ?>
										<a href="<?php the_sub_field( 'project_portfolio_block_img' ); ?>" class="project-portfolio-img">
											<img class="lazy" src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAEALAAAAAAQAAkAAAIKjI+py+0Po5yUFQA7" data-src="<?php the_sub_field( 'project_portfolio_block_img' ); ?>" alt="<?php the_title(); ?>" />
										</a>
									<?php } ?>
								</div>
								...
								<div class="project-portfolio-blocks__img project-portfolio-blocks__gallery">
									<?php foreach ( $gallery as $gallery_image ): ?>
										<a href="<?php echo esc_url($gallery_image['url']); ?>" class="project-portfolio-img">
											<img class="lazy" src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAEALAAAAAAQAAkAAAIKjI+py+0Po5yUFQA7" data-src="<?php echo esc_url($gallery_image['url']); ?>" alt="<?php the_title(); ?>" />
										</a>
									<?php endforeach; ?>
								</div>
								...
								<div class="project-portfolio-blocks__img project-portfolio-blocks__gallery project-portfolio-blocks__gallery--three-img">
									<?php foreach ( $gallery_3_img as $gallery_3_img_image ): ?>
										<a href="<?php echo esc_url($gallery_3_img_image['url']); ?>" class="project-portfolio-img">
											<img class="lazy" src="data:image/gif;base64,R0lGODlhEAAJAIAAAP///wAAACH5BAEAAAEALAAAAAAQAAkAAAIKjI+py+0Po5yUFQA7" data-src="<?php echo esc_url($gallery_3_img_image['url']); ?>" alt="<?php the_title(); ?>" />
										</a>
									<?php endforeach; ?>
								</div>
	...
	<div class="section section-order-consultation paraxify">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="section-title">Узнайте стоимость строительства под ключ. Закажите бесплатную консультацию!</div>
					<p>Выезд на участок или встреча в офисе для определения порядка работ.</p>
				</div>
