...
<div class="page-content-wrapper">
	<div class="container">
		<div class="row">
			...
			<div class="col-12">
				<h1 class="page-title">
					Рады приветствовать вас на сайте строительной <span>компании Luks!</span>
				</h1>
			</div>
		</div>
	...
	<?php 
		...
		include 'template-parts/about-company/team.php';
		include 'template-parts/about-company/services.php';
	...
	<?php 
		...
		include 'template-parts/about-company/build-geography.php';
		include 'template-parts/about-company/advantages.php';
