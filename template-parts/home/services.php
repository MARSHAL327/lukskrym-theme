				...
				<div class="services-column">
					<div class="services-item">
						<a href="<?php the_field( 'service_url_1', 2 ); ?>/">
							<img class="lazy" src="data:image/gif;base64,R0lGODlhSgAZAIAAAP///wAAACH5BAEAAAEALAAAAABKABkAAAIrjI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNf2jef6zvf+D8QUAAA7" data-src="<?php echo get_stylesheet_directory_uri() . '/assets/images/services/services-item-1.png' ?>" alt="<?php the_field( 'service_title_1', 2 ); ?>">
					...
					<div class="services-item">
						<a href="<?php the_field( 'service_url_2', 2 ); ?>/">
							<img class="lazy" src="data:image/gif;base64,R0lGODlhJQAVAIAAAP///wAAACH5BAEAAAEALAAAAAAlABUAAAIajI+py+0Po5y02ouz3rz7D4biSJbmiaYqWgAAOw==" data-src="<?php echo get_stylesheet_directory_uri() . '/assets/images/services/services-item-2.png' ?>" alt="<?php the_field( 'service_title_2', 2 ); ?>">
				...
				<div class="services-column">
					<div class="services-item">
						<a href="<?php the_field( 'service_url_3', 2 ); ?>/">
							<img class="lazy" src="data:image/gif;base64,R0lGODlhJQAjAIAAAP///wAAACH5BAEAAAEALAAAAAAlACMAAAIjjI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNc2VgAAOw==" data-src="<?php echo get_stylesheet_directory_uri() . '/assets/images/services/services-item-3.png' ?>" alt="<?php the_field( 'service_title_3', 2 ); ?>">
							<div class="services-item__title services-item__title--wide">
