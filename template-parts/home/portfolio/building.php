...
<script>
	jQuery(document).ready(function($) {
		...
		$(function() {
			swapElements($('#portfolio-projects .row-building .col-lg-4'), 0, 2);
		});
	});
</script>

<?php $portfolio_building = get_field( 'portfolio_building' ); ?>

<?php if ( $portfolio_building ): ?>

	<?php foreach ( $portfolio_building as $post ):  ?>
