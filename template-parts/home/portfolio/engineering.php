...
<script>
	jQuery(document).ready(function($) {
		...
		$(function() {
			swapElements($('#portfolio-projects .row-engineering .col-lg-4'), 0, 2);
		});
	});
</script>

<?php $portfolio_engineering = get_field( 'portfolio_engineering' ); ?>

<?php if ( $portfolio_engineering ): ?>

	<?php foreach ( $portfolio_engineering as $post ):  ?>
