...
<script>
	jQuery(document).ready(function($) {
		...
		$(function() {
			swapElements($('#portfolio-projects .row-reconstruction .col-lg-4'), 0, 2);
		});
	});
</script>

<?php $portfolio_reconstruction = get_field( 'portfolio_reconstruction' ); ?>

<?php if ( $portfolio_reconstruction ): ?>

	<?php foreach ( $portfolio_reconstruction as $post ):  ?>
