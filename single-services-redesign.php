			...
			<div class="container">
				<div class="text-image__wrap">
					...
					<div class="text-image__image">
						<img src="<?php echo get_field('opisanie_pod_bannerom')['izobrazhenie']['sizes']['large']; ?>" alt="alt">
					</div>
				</div>
			</div>
		</section>
					...
					<div class="col-lg-6">
						...
						<div class="manager">
							<div class="manager__img">
								<img src="<?php the_field( 'manager_img' ); ?>" alt="Менеджер отдела продаж">
							</div>
...
<!-- 									
		...
		<?php } ?>
			...
			<div class="section full-cycle-company">
				<div class="container">
					<div class="row">
					...
					<!-- начало для страницы индивидуальное проектирование 01/07/22-->

	<div class="col-lg-6">
							<div class="building-from__text">
<!--img class="lazy loaded" style="float:right !important; padding:5px;" src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie1']['sizes']['medium_large']; ?>" data-src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie1']['sizes']['medium']; ?>" title="постройка элитных домов в Севастополе" alt="Дом, построенный компанией Luks в Севастополе под ключ" data-was-processed="true"-->
								
								<?php echo get_field('na_chto_obratit_vnimanie')['opisanie4']; ?>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="building-from__img"> 
								<? if(isset(get_field('na_chto_obratit_vnimanie')['izobrazhenie1']['sizes']['large'])){?>
								<img class="lazy loaded еуые" src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie1']['sizes']['large']; ?>" data-src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie1']['sizes']['large']; ?>" title="постройка элитных домов в Севастополе" alt="Дом, построенный компанией Luks в Севастополе под ключ" data-was-processed="true"><?}?>
							</div>
						</div>

<!-- конец для страницы индивидуальное проектирование 01/07/22-->	
			...
			<div class="section block-portfolio">
				<div class="container">
					...
					<div class="block-portfolio__items">
                        <?php //var_dump(get_field('portfolio')['bloki'][0]['portfolio']);
					...
					<div class="specialists__wrap">
						<div class="specialists__image">
							<?php if($speczialist['foto']) { ?>
								<img src="<?php echo $speczialist['foto']['sizes']['large']; ?>" alt="alt">
							<?php } ?>
						</div>
		...
		<section class="section text-image">
			<div class="container">
				<div class="text-image__wrap">
					...
					<div class="text-image__image">
						<img src="<?php echo get_field('seo_tekst')['izobrazhenie']['sizes']['medium_large']; ?>" alt="alt">
					</div>
				</div>
			</div>
		</section>
        <?php } ?>
			...
			?>
<!-- начало для страницы индивидуально проектирование 01/07/22-->
				<div class="section building-from">
				<div class="container">
					<div class="row"><div class="col-lg-12">
							<?php echo get_field('na_chto_obratit_vnimanie')['opisanie2']; ?>
						</div></div></div></div>
				<!-- конец для страницы индивидуально проектирование 01/07/22-->
			<?php
...
<!--img class="lazy loaded" style="float:right !important; padding:5px;" src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie']['sizes']['medium_large']; ?>" data-src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie']['sizes']['medium']; ?>" title="постройка элитных домов в Севастополе" alt="Дом, построенный компанией Luks в Севастополе под ключ" data-was-processed="true"-->
						...
						<div class="col-lg-6">
							<div class="building-from__img"> 
								<img class="lazy loaded" src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie']['sizes']['large']; ?>" data-src="<?php echo get_field('na_chto_obratit_vnimanie')['izobrazhenie']['sizes']['large']; ?>" title="постройка элитных домов в Севастополе" alt="Дом, построенный компанией Luks в Севастополе под ключ" data-was-processed="true">
							</div>
						</div>
						<div class="col-lg-12">
							<?php echo get_field('na_chto_obratit_vnimanie')['opisanie1']; ?>
						</div>
						<!-- начало для страницы индивидуально проектирование 01/07/22-->
				<div class="section building-from">
				<div class="container">
					<div class="row"><div class="col-lg-12">
							<?php echo get_field('na_chto_obratit_vnimanie')['opisanie3']; ?>
						</div></div></div></div>
				<!-- конец для страницы индивидуально проектирование 01/07/22-->
					</div>
				</div>
			...
			<div class="section section-build-geography build-geography_services">
				<div class="container">
					<div class="row">
						<div class="col-12 text-center">
