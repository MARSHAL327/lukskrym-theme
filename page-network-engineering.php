...
<div class="page-content-wrapper">
	...
	<?php 
		...
		include 'template-parts/network-engineering/about-network-engineering.php';
		include 'template-parts/network-engineering/engineering-communications-design.php';
