...
/*
Template Name: Строительство домов
*/
...
<div class="page-content-wrapper">
	<div class="container">
		<div class="row">
			...
			<div class="col-12 text-center">
				<h1 class="page-title">
					<?php the_field( 'page_construction_houses_title' ); ?>
				</h1>
				<p class="section-description">
					<?php the_field( 'page_construction_houses_description' ); ?>
				</p>
			</div>
		</div>
	</div>
	...
	<?php 
		...
		include 'template-parts/construction-houses/construction-types.php';
        include 'template-parts/mortgage_block.php';
		include 'template-parts/construction-houses/material-characteristics.php';
		include 'template-parts/construction-houses/choose-us.php';
		include 'template-parts/construction-houses/contact-us.php';
		include 'template-parts/construction-houses/for-legal-entities.php';
