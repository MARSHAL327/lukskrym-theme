...
<div class="page-content-wrapper">
	<div class="container">
		...
		<div class="about-design-project">
			<div class="row">
				<div class="col-xxl-6">
					<div class="about-design-project__img">
						<?php if ( get_field( 'about_design_project_img' ) ) { ?>
							<img src="<?php the_field( 'about_design_project_img' ); ?>" alt="<?php the_title(); ?>" />
						<?php } ?>
					</div>
				</div>
				<div class="col-xxl-6">
					<div class="about-design-project__text">
						<?php the_field( 'about_design_project_text' ); ?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="about-design-project__text--2">
						<?php the_field( 'about_design_project_text_2' ); ?>
					</div>
				</div>
			</div>
		</div>

		<div class="stages-design-project">
			<div class="row">
				<div class="col-xxl-6">
					<div class="stages-design-project__text">
						<?php the_field( 'stages_design_project_text' ); ?>
					</div>
				</div>
				<div class="col-xxl-6">
					<div class="stages-design-project__img">
						<?php if ( get_field( 'stages_design_project_img' ) ) { ?>
							<img src="<?php the_field( 'stages_design_project_img' ); ?>" alt="<?php the_title(); ?>" />
						<?php } ?>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="stages-design-project__text--2">
						<?php the_field( 'stages_design_project_text_2' ); ?>
					</div>
				</div>
			</div>
		</div>
